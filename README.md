...
RU:
## Краткое описание:
Это моя авторская локализация на русский язык для Balatro (как для стандартного релиза 1.0.0n-FULL, так и для экспериментального билда 1.0.1c-FULL). Мод никак не влияет на получение достижений. 
