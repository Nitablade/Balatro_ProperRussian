return {
    descriptions = {
        Joker = {
            ...
            j_mime = {
                ...
                text = {
                    "Перезапускает все",
                    "особенности {C:attention}удерживаемых",
                    "{C:attention}в руке{} карт"
                }
            },
            j_credit_card = {
            ...
            j_chaos = {
                name = "Клоун Хаос",
                text = {
                    "{C:attention}+#1#{} к бесплатным {C:green}перебросам",
                    "в каждой лавке"
                }
            },			
            j_misprint = {
            ...
            j_egg = {
                name = "Яйцо",
                text = {
                    "Получает {C:money}$#1#{} к",
                    "своей {C:attention}стоимости продажи{}",
                    "в конце раунда"
                }
            },
            j_burglar = {
            ...
            j_obelisk = {
                ...
                text = {
                    "{X:mult,C:white} X#1# {} множ. за каждую",
                    "последовательную руку, сыгранную",
                    "без вашей наиболее часто играемой",
					"{C:attention}покерной комбинации",
                    "{C:inactive}(сейчас: {X:mult,C:white} X#2# {C:inactive} множ.)"
                }
            },
            ...
            j_luchador = {
                ...
                text = {
                    ...
                    "текущего {C:attention}Босс-блайнда{}",
					"при продаже"
                }
            },
            j_photograph = {
            ...
            j_flash = {
                ...
                text = {
                    ...
                    "использованный {C:attention}переброс{} в лавке",
                    "{C:inactive}(сейчас: {C:mult}+#2#{C:inactive} множ.)"
                }
            },
            j_popcorn = {
            ...
            j_satellite = {
                ...
                text = {
                    ...
                    "карту {C:planet}планеты{} в этой партии,",
                    "в конце раунда",
                    "{C:inactive}(сейчас {C:money}$#2#{C:inactive})"
                },
                unlock = {
            ...
            j_astronomer = {
                ...
                text = {
                    ...
                    "и {C:planet}Небесные наборы{} в лавке",
            ...
            j_perkeo = {
                ...
                text = {
                    ...
                    "при выходе из {C:attention}лавки"
                },
                unlock = {
                    "{E:1,s:1.3}?????"
                }
        ...
        Voucher = {
            ...
            v_hone = {
                ...
                text = {
                    ...
                    "и {C:dark_edition}Полихромные{} карты в лавке",
                    "появляются в {C:attention}#1# раза{} чаще"
                }
            },
            v_reroll_surplus = {
                ...
                text = {
                    "Перебросы стоят на {C:money}$#1#{} меньше"
                }
            },
            ...
            v_magic_trick = {
                name = "Фокус",
                text = {
                    "В {C:attention}лавке{} могут появиться",
            ...
            v_directors_cut = {
                ...
                text = {
                    "Позволяет перебросить Босс-блайнд",
                    "{C:attention}1{} раз за Анте,",
                    "{C:inactive}({C:money}$#1#{}{C:inactive} за переброс)"
                }
            },
            v_paint_brush = {
            ...
            v_illusion = {
                name = "Иллюзия",
                text = {
                    "{C:attention}Игральные карты{} в лавке",
                    "могут появляться с {C:enhanced}улучшением{},",
                    "{C:dark_edition}выпуском{} и/или {C:attention}печатью{}"
                },
                unlock = {
                    "Купите суммарно",
        ...
        Tarot = {
            ...
            c_wheel_of_fortune = {
                ...
                text = {
                    ...
                    "{C:dark_edition}Фольгированный{}, {C:dark_edition}Голографический{}",
                    "или {C:dark_edition}Полихромный{} выпуск",
                    "к случ. {C:attention}джокеру"
                }
            },
            c_strength = {
                name = "Сила",
            ...
            c_temperance = {
                name = "Умеренность",
                text = {
                    "Даёт общую стоимость",
                    "продажи джокеров на руках",
                    "{C:inactive}(максимум {C:money}$#1#{C:inactive})",
                    "{C:inactive}(сейчас: {C:money}$#2#{C:inactive})"
                }
            },
            ...
            c_star = {
                name = "Звезда",
                text = {
                    "Меняет до {C:attention}#1#{} выбранных карт",
                    "превращая их в карты {V:1}#2#{}"
                }
            },
        ...
        Spectral = {
            ...
            c_ectoplasm = {
                name = "Эктоплазма",
                text = {
                    "Добавляет {C:dark_edition}Негативный{} выпуск",
                    "к случ. {C:attention}джокеру{},",
                    "{C:red}-#1#{} к размеру руки"
                }
            },
            ...
            c_hex = {
                name = "Сглаз",
                text = {
                    "Добавляет {C:dark_edition}Полихромный{} выпуск",
        ...
        Stake = {
            ...
            stake_black = {
                name = "Чёрная ставка",
                text = {
                    "В лавке могут появиться {C:attention}Вечные{} джокеры",
        ...
        Tag = {
            ...
            tag_negative = {
                ...
                text = {
                    ...
                    "в лавке становится {C:dark_edition}Негативным"
                }
            },
            tag_foil = {
                ...
                text = {
                    "Следующий стандартный джокер",
                    "в лавке становится {C:dark_edition}Фольгированным"
                }
            },
            tag_holo = {
                ...
                text = {
                    "Следующий стандартный джокер",
                    "в лавке становится {C:dark_edition}Голографическим"
                }
            },
            tag_polychrome = {
                ...
                text = {
                    "Следующий стандартный джокер",
                    "в лавке становится {C:dark_edition}Полихромным"
                }
            },
            tag_investment = {
            ...
            tag_d_six = {
                name = "Жетон D6",
                text = {
                    "Стоимость перебросов", "в следующей лавке",
    ...
    misc = {
        ...
        dictionary = {
            ...
            b_run_info_2 = "партии",
            b_options = "Настройки",
            b_reroll_boss = "Перебросить босс-блайнд",
            ...
            ml_edition_seal_enhancement_explanation = {
                ...
                "одно улучшение, выпуск и печать"
            },
        ...
        v_text = {
            ...
            ch_m_reroll_cost = {
                "Стартовая стоимость переброса: {C:money}$#1#{}"
            },
            ch_m_joker_slots = {
            ...
            ch_c_chips_dollar_cap = {
                "Количество {C:blue}фишек{} не может превысить текущее количество {C:money}$"
            },
            ch_c_none = {
                "{C:inactive}Нет"
            },
            ...
            ch_c_all_eternal = {
                "Все джокеры в лавке становятся {C:eternal}Вечными{}"
            },
            ch_c_flipped_cards = {
